...
@testset "Continuous/FE detection" begin
    ...
    @test MetricsLinearModels.has_cont_fe_interaction(@formula(y ~ x + fe(y)&fe(z))) == false
    ...
    @test MetricsLinearModels.has_cont_fe_interaction(@formula(y ~ x + fe(y)&fe(z)&a)) == true
